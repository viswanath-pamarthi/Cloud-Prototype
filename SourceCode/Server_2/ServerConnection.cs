    ...
    public class ServerConnection
    {
        ...
        public void processIncoming()
        {
            lock (m_socket)
            {
                ...
                while ((true))
                {
                    //var client =m_socket.Client.Accept();
                    //m_socket.
        ...
        //Read the stream and save the content to the file got from another server...... seems like i have to write the reading part of the code in new thread Server Cloud
        void syncCommand()
        {
